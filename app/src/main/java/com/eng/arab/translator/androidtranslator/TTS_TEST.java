/*Skip to content
        ...
        This repository
        Search
        Watch 190  Star 971  Fork 2,372 survivingwithandroid/Surviving-with-android
        Code  Issues 7  Pull requests 3  Projects 0  Pulse  Graphs
        Branch: master Find file Copy pathSurviving-with-android/Android_Speech/app/src/main/java/speech/survivingwithandroid/com/android_speech/MainActivity.java
        3075eed  on Feb 17, 2015
@survivingwithandroid survivingwithandroid Android TTS
        1 contributor
        RawBlameHistory
        143 lines (115 sloc)  4.44 KB
       */
...
//        seekSpeed = (SeekBar) findViewById(R.id.seekSpeed);
    ...
    private void speech() {
        ...
        //engine.speak(editText.getText().toString(), TextToSpeech.QUEUE_FLUSH, null, "test");
                //editText.getText().toString(), TextToSpeech.QUEUE_FLUSH, null, null);
  ...
  /*  Contact GitHub
    API Training
    Shop Blog About
        © 2016GitHub,Inc.Terms Privacy Security Status Help*/